...
AI_LAUNCH_ENABLE_BUTTON = 'X'      # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
...
#
SAVE_PATH_BTN = "A"        # button to save path
