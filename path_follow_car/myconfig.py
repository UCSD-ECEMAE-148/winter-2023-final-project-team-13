...
GPS_SERIAL = '/dev/ttyUSB1' # serial device path, like '/dev/ttyAMA1' or '/dev/$
GPS_SERIAL_BAUDRATE = 460800
GPS_NMEA_PATH = None        # File used to record gps, like "nmea.csv".
#                             # If this is set then when waypoints are recorded$
#                             # the underlying NMEA sentences will also be save$
#                             # this file along with their time stamps.  Then w$
#                             # the path is loaded and played in auto-pilot mod$
#                             # the NMEA sentences that were recorded will be p$
#                             # This is for debugging and tuning the PID withou$
...
# 
# #Path following
PATH_FILENAME = "donkey_path.csv"   # the path will be saved to this filename
...
PID_THROTTLE = 0.27                  # constant throttle value during path following
